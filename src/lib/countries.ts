...
export const countries: Country[] = [
  ...
  { code: "AG", name: "Antigua-et-Barbuda", dialCode: "+1 268", flag: "🇦🇬" },
  ...
  { code: "BB", name: "Barbade", dialCode: "+1 246", flag: "🇧🇧" },
  { code: "BE", name: "Belgique", dialCode: "+32", flag: "🇧🇪" },
  { code: "BZ", name: "Belize", dialCode: "+501", flag: "🇧🇿" },
  { code: "BJ", name: "Bénin", dialCode: "+229", flag: "🇧🇯" },
  { code: "BM", name: "Bermudes", dialCode: "+1 441", flag: "🇧🇲" },
  { code: "BT", name: "Bhoutan", dialCode: "+975", flag: "🇧🇹" },
  { code: "BY", name: "Biélorussie", dialCode: "+375", flag: "🇧🇾" },
  { code: "MM", name: "Birmanie", dialCode: "+95", flag: "🇲🇲" },
  ...
  { code: "DM", name: "Dominique", dialCode: "+1 767", flag: "🇩🇲" },
  ...
  { code: "GD", name: "Grenade", dialCode: "+1 473", flag: "🇬🇩" },
  ...
  { code: "JM", name: "Jamaïque", dialCode: "+1 876", flag: "🇯🇲" },
  ...
  { code: "PR", name: "Porto Rico", dialCode: "+1 787", flag: "🇵🇷" },
  ...
  { code: "LC", name: "Sainte-Lucie", dialCode: "+1 758", flag: "🇱🇨" },
  ...
  { code: "TT", name: "Trinité-et-Tobago", dialCode: "+1 868", flag: "🇹🇹" },
...
export const getCountrySuggestions = (query: string): Country[] => {
...
export function getDefaultCountry(code = "NE"): Country {
  return (
    countries.find((c) => c.code === code) ||
    countries.find((c) => c.code === "NE") ||
    countries[0]
  );
}
